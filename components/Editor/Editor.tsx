...
const Editor: React.FC<EditorProps> = ({
  ...
  const attachIframeListeners = (doc: Document) => {
    ...
    const pageElement = doc.querySelector(".page") as HTMLElement;
    pageElement.addEventListener("input", updateHtml);
    pageElement.addEventListener("blur", updateHtml);
  };
  ...
  return (
    <div className="flex flex-col h-full bg-gray-200">
      <h2 className="text-xl font-semibold p-4 bg-white border-b border-gray-200">
